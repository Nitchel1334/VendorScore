...
const reportTypes = [
  {
    ...
    iconBg: "bg-blue-100",
    highlights: ["Total Inflow: ₹85,400", "Total Outflow: ₹12,800", "Net Cash Flow: ₹72,600"],
  },
  {
    id: "income",
    ...
    iconBg: "bg-green-100",
    highlights: ["Revenue: ₹85,400", "Expenses: ₹12,800", "Net Profit: ₹72,600 (85%)"],
  },
  {
    id: "ledger",
    ...
    highlights: ["340 transactions", "June 1–13, 2026", "All categories included"],
  },
  {
    id: "loan",
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-4">
        ...
        <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl">
          <p className="text-amber-700" style={{ fontSize: "0.7rem", fontWeight: 600 }}>
            📋 ANNOTATION: Reports generated server-side via Frappe print formats.
            PDF via WeasyPrint, Excel via openpyxl. WhatsApp share via Twilio/WATI API.
            Auto-emailed weekly to registered email if provided.
          </p>
        </div>
      </div>
    </div>
